...
public class MainClass {
    ...
    public static void main(String[] args) throws InvalidCode {
		...
		System.out.println(b1.getName()); // Uncle-$crooge 
		...
		try {
			b1.deposit(c1, 7, 360.0); // 500.5+360=860.5
			b1.deposit(c4, 35, 270.0);// 252.4+270= 522.4 // c4 = 1
			b1.withdraw(c3, 28, 350.0); // 800-350=450
			b1.withdraw(c2, 19, 350.0);
			b1.withdraw(c3, 41, 158.0); // 450-158=292
			b1.transfer(c1, c3, 8, 400.0); // 860.5-400=460.5----292+400= 692
			a1 = b1.getAccount(c1);   System.out.println(a1); // John 5 500.5
